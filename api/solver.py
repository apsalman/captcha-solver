...
def solve_captcha():
    ...
    try:
        ...
        **다양한 질문 유형 예시:**
        - 질문이 "광진빈칸라" 이고 이미지에 "광진빌라"가 있다면, 정답은 "빌" 입니다.
        - 질문이 "빈칸원빌딩" 이고 이미지에 "청원빌딩"이 있다면, 정답은 "청" 입니다.
        - 질문이 "이화산업빈칸" 이고 이미지에 "이화산업빌딩"이 있다면, 정답은 "빌딩" 입니다.
        - 질문이 "빈칸나은행" 이고 이미지에 "하나은행"이 있다면, 정답은 "하" 입니다.
        - 질문이 "빈칸K스카이뷰" 이고 이미지에 "인천SK스카이뷰"가 있다면, 정답은 "인천S" 입니다.
